...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mutationSummary = __webpack_require__(4);
	                ...
	                mutations.forEach(function (mutation) {
	                    if (mutation.type === "childList") {
	                        for (var _i = 0; _i < mutation.addedNodes.length; _i++) {
	                            var addedNode = mutation.addedNodes[_i];
	...
	var iframeObserver = new _mutationSummary2.default({
	    callback: function callback(e) {
	        for (var _i2 = 0; _i2 < e.length; _i2++) {
	            for (var j = 0; j < e[_i2].added.length; j++) {
	                var elem = e[_i2].added[j];
	...
	var i = 0;
	_MessageManager2.default.response("ping", function (a) {
