...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ObjectConverter = __webpack_require__(45);
	
	var _ObjectConverter2 = _interopRequireDefault(_ObjectConverter);
	
	var _AttributeWatcher = __webpack_require__(46);
	
	var _AttributeWatcher2 = _interopRequireDefault(_AttributeWatcher);
	
	var _mutationSummary = __webpack_require__(47);
	...
	_MessageManager2.default.response("fetch-tree", function (m) {
	...
	_MessageManager2.default.response("fetch-node", function (m) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AttributeConverters = __webpack_require__(51);
	
	var _AttributeConverters2 = _interopRequireDefault(_AttributeConverters);
	    ...
	    (0, _createClass3.default)(ObjectConverter, [{
	        ...
	        value: function fromAttribute(attr) {
	            ...
	            try {
	                ...
	                (0, _AttributeConverters2.default)(attrInfo);
	                return attrInfo;
	            } catch (e) {
	                return {
	                    name: attr.name.name,
